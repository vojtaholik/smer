...
Provider-specific endpoints can also be set in `~/.smer/config.toml`. Scan-heavy local providers default to two-minute intervals; poll intervals are never shorter than 60 seconds.
